...
- 训练图片：284张
- 验证图片：82张
- 测试图片：83张（未参与训练与最佳权重选择）

完整参数见 [`results/training/yolo26n/args.yaml`](../results/training/yolo26n/args.yaml)，逐轮指标见 [`results/training/yolo26n/results.csv`](../results/training/yolo26n/results.csv)。
...
```text
SHA256  0AC3680C4786130DC031027BC306173820BF7B81C4E785A7BB236312225CC4F3
